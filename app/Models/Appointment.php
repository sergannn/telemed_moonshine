...
class Appointment extends Model
{
    ...
    public static function generateAppointmentUniqueId($input): string
    {
        $stringifyed_input = json_encode($input);
        $short_appointment_unique_id = Str::random(21);
        $time = time();
        ...
        return hash('sha256', "$stringifyed_input$short_appointment_unique_id$time");
    }
