...
class User extends Authenticatable implements HasApiTokens, MustVerifyEmail, HasMedia
{
    use HasApiTokensTrait, HasFactory, HasRoles, Notifiable, InteractsWithMedia;
