...
class _ChatBottomSheetState extends State<ChatBottomSheet> {
  ...
  Future<ChatMessage> _sendChatMessage(
      {required String message, ParticipantId? recipient}) async {
    final chatMessage = ChatMessage(
      fromParticipantId: widget.client.participants.local.id,
      fromParticipantName:
          widget.client.participants.local.info.username ?? 'Guest',
    ...
    final eventJson = chatMessage.toJson()
      ..['event'] = AppMessageEvent.chatMessage.value;
  ...
  Future<ChatMessageReaction> _sendChatMessageReaction({
    ...
    final eventJson = chatMessageReaction.toJson()
      ..['event'] = AppMessageEvent.messageReaction.value;
      ...
      child: SafeArea(
        child: Padding(
          padding: EdgeInsets.fromLTRB(
              20, 16, 0, bottomInsets == 0 ? 12 : bottomInsets),
          child: Column(
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (_, i) {
                    ...
                    return _MessageBubble(
                      message: message,
                      onReaction: (reaction) => _sendChatMessageReaction(
    ...
    return Stack(
      children: [
        ...
        Positioned(
          ...
          bottom: 0,
          child:
              _Reactions(reactions: message.reactions, onReaction: onReaction),
        )
      ],
    );
  }
            ...
            child: Container(
              ...
              child: Wrap(
                ...
                children: widget.reactions.entries
                    ...
                    .map((entry) => _Reaction(
                        reaction: entry.key, count: entry.value.length))
                    .toList(),
              ),
            ),
          ),
...
class _Reaction extends StatelessWidget {
  _Reaction({required this.reaction, required this.count})
      : super(key: ValueKey(reaction));
