...
import 'package:doctorq/daily/streaming_settings_bottom_sheet.dart';
...
class _RecordingButtonState extends State<RecordingButton> {
            ...
            : Padding(
                ...
                child: GestureDetector(
                  onLongPress: _isStreamingOrRecording
                      ...
                      : () {
                          setState(
                              () => _isInStreamingMode = !_isInStreamingMode);
                          ScaffoldMessenger.of(context).hideCurrentSnackBar();
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                                content: Text(
                                    '${_isInStreamingMode ? 'Live streaming' : 'Recording'} mode')),
                          );
                        },
                  child: Container(
                    padding:
  ...
  Future<void> _onPressed() async {
    if (_isStreamingOrRecording) {
      ...
      final endpoints = endpointsJson == null
          ? null
          : LiveStreamEndpoints.fromJson(jsonDecode(endpointsJson));
      ...
      unawaited(widget.prefs.setString(
          'streamingEndpoints', jsonEncode(updatedEndpoints.toJson())));
