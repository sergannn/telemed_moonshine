...
Future<String?> showUserSettingsBottomSheet(
        BuildContext context, String? name) =>
    showModalBottomSheet(
        context: context, builder: (_) => UserSettingsBottomSheet(name: name));
...
class UserSettingsBottomSheet extends StatefulWidget {
  ...
  @override
  State<UserSettingsBottomSheet> createState() =>
      _UserSettingsBottomSheetState();
}
      ...
      child: SingleChildScrollView(
        child: Padding(
          padding: EdgeInsets.fromLTRB(
              20, 8, 20, MediaQuery.of(context).viewInsets.bottom),
          child: Column(
