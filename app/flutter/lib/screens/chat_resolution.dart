...
class ChatResolution extends StatefulWidget {
  ...
  @override
  State<ChatResolution> createState() => _ChatResolutionState();
}

class _ChatResolutionState extends State<ChatResolution> {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Center(
                          child: Image.asset(
                            'assets/images/chatresolution.png',
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    GestureDetector(
                        child: _buildCircleItem(Icons.date_range, 'Записаться'),
                        onTap: () {
...
// Необходимые enum для кнопки
enum ButtonVariant { FillBlueA400 }

enum ButtonFontStyle { SourceSansProSemiBold18 }
