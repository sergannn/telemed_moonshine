...
import '../../messaging_details_screen/messaging_details_screen.dart';
...
class ListrickysebastianTwoItemWidget extends StatelessWidget {
  ...
  String? uId;
  String user;
  ListrickysebastianTwoItemWidget({Key? key, required this.user, required this.index}) : super(key: key) {
