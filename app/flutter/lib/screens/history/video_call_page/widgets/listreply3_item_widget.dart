...
import 'package:doctorq/screens/history/video_call_details_screen/video_call_details_screen.dart';
...
class Listreply3ItemWidget extends StatelessWidget {
  int index;
  Listreply3ItemWidget({Key? key, required this.index}) : super(key: key);
...
bool isRtl = context.locale==Constants.arLocal;
 ...
 =>HistoryVideoCallDetailsScreen(doctor: doctorList[index],)),
  );
        },
