...
import 'widgets/listreply2_item_widget.dart';
import 'widgets/listreply_two1_item_widget.dart';
import 'package:doctorq/app_export.dart';
import 'package:doctorq/widgets/custom_search_view.dart';
import 'package:flutter/material.dart';

// ignore_for_file: must_be_immutable
class HistoryVoiceCallPage extends StatelessWidget {
  TextEditingController autoLayoutVerController = TextEditingController();

  HistoryVoiceCallPage({Key? key}) : super(key: key);
            ...
            Align(
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Expanded(
                      child:  CustomSearchView(isDark:isDark,
                        width: 324,
                        focusNode: FocusNode(),
                ...
                child: Padding(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return Listreply2ItemWidget(index: index,);
                    },
                  ),
                ),
              ),
              ...
              child: Align(
                ...
                child: Padding(
                  ...
                  child: ListView.builder(
                    ...
                    itemCount: 2,
                    itemBuilder: (context, index) {
                      return ListreplyTwo1ItemWidget(index: index+2);
                    },
                  ),
                ),
              ),
