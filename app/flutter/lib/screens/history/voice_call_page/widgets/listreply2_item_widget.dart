...
import 'package:doctorq/screens/history/voice_call_details_screen/voice_call_details_screen.dart';
...
class Listreply2ItemWidget extends StatelessWidget {
  int index;
  Listreply2ItemWidget({Key? key, required this.index}) : super(key: key);
