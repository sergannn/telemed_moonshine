...
class StoryItemWidget extends StatelessWidget {
  ...
  StoryItemWidget({Key? key, required this.index, required this.item})
      : super(key: key);
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            image: DecorationImage(
                fit: BoxFit.cover,
                image: NetworkImage(
                    'https://admin.onlinedoctor.su/storage/' + item["image"])),
            ...
            children: [
              /*  Padding(
                ...
                child: CommonImageView(
                  ...
                  url: 'https://admin.onlinedoctor.su/storage/' + item["image"],
              ...
              Container(
                ...
                child: Text(
                  item['title'], //specialistList[index].name,
                  //поменял на 1
                  maxLines: 1,
