...
class VideoResolution extends StatefulWidget {
  ...
  @override
  State<VideoResolution> createState() => _VideoResolutionState();
}

class _VideoResolutionState extends State<VideoResolution> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Видео запись с врачом'),
        actions: [
          IconButton(
